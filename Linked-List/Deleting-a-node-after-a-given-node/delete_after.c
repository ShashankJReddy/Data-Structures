...
struct node *delete_end(struct node *);     //For deleting the last node fo the linked list
struct node *delete_given_node(struct node *);  //For deleting the given node in Linked list
...
int main()
{
  ...
  start=display_ll(start);
  printf("Now deleting the Last node of the Linked List\n");
  start=delete_end(start);
  printf("The Linked List after deleting the last node is\n");
  start=display_ll(start);
  printf("Now consider in deleting a specific node whose value is known\n");
  start=delete_given_node(start);
  printf("The Linked List after deleting the given node is\n");
  start=display_ll(start);
  printf("\nNow consider in deleting a node after a node whose data value is known\n");
...
struct node *delete_end(struct node *start)
{
    ...
    preptr->next=NULL;
    printf("The data %d in the last node is now deleted\n",ptr->data);
    free(ptr);
    return start;
}
...
{
    int val;                                //To hold the value given by the user
    struct node *ptr,*preptr;
    ptr=start;
    printf("\nEnter the value of the node which has to be deleted\n");
    scanf("%d",&val);
    if(ptr->data==val)                      //What if the node to be deleted id the first node
    {
        start=delete_be(start);
        return start;
    }
...
struct node *delete_after(struct node *start)
{
    ...
    ptr=start;
    preptr=ptr;
    while(preptr->data!=val)            //As we are deleting the node after the given node
    {
        preptr=ptr;
        ptr=ptr->next;
    }

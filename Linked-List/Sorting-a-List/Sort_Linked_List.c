...
struct node *sort_list(struct node *);      //For sorting the entire Linked List
...
int main()
{
  ...
  start=display_ll(start);
  printf("Now we SORT the entire Linked list\n");
  start=sort_list(start);
  printf("The elements in the Sorted Linked List are\n");
  start=display_ll(start);
...
struct node *sort_list(struct node *start)
{
    ...
    printf("The elements in the list are sorted\n");
    return start;
}
